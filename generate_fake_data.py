...
def show_DM_plot(g,mphi,mx):
    ...
    plt.title(title)
    plt.legend(['astro','atm','muon','data','true_astro','true_atm','true_muon'])
    plt.xlim(1e3, 1e7)
    plt.ylim(5e-1, 2e3)
    # plt.show()

# show_DM_plot(3e-1,1e7,1e8)
# show_DM_plot(3e-1,1e3,1e6)
show_DM_plot(3e-1,1e0,1e3)
show_DM_plot(1e0, 1e-2,1e0)
